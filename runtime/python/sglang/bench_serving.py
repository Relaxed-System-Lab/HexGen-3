...
class BenchmarkMetrics:
    ...
    p100_e2e_latency_ms: float
    percentiles_e2e_latency_ms: List[float]
    concurrency: float
...
def _percentiles_ms_1_to_100(samples: List[float]) -> List[float]:
    """p1..p100 in milliseconds; samples are in seconds. Index i corresponds to p(i+1)."""
    if not samples:
        return [0.0] * 100
    arr = np.asarray(samples, dtype=np.float64)
    return (np.percentile(arr, np.arange(1, 101)) * 1000).tolist()
...
def calculate_metrics(
    ...
    percentiles_e2e_ms = _percentiles_ms_1_to_100(e2e_latencies)
    percentiles_ttft_ms = _percentiles_ms_1_to_100(ttfts)
    percentiles_itl_ms = _percentiles_ms_1_to_100(itls)
    ...
    metrics = BenchmarkMetrics(
        ...
        * 1000,  # ttfts is empty if streaming is not supported by backend
        ...
        p90_ttft_ms=percentiles_ttft_ms[89],
        p95_ttft_ms=percentiles_ttft_ms[94],
        p99_ttft_ms=percentiles_ttft_ms[98],
        p100_ttft_ms=percentiles_ttft_ms[99],
        ...
        p90_itl_ms=percentiles_itl_ms[89],
        p95_itl_ms=percentiles_itl_ms[94],
        p99_itl_ms=percentiles_itl_ms[98],
        p100_itl_ms=percentiles_itl_ms[99],
        ...
        p90_e2e_latency_ms=percentiles_e2e_ms[89],
        p95_e2e_latency_ms=percentiles_e2e_ms[94],
        p99_e2e_latency_ms=percentiles_e2e_ms[98],
        p100_e2e_latency_ms=percentiles_e2e_ms[99],
        percentiles_e2e_latency_ms=percentiles_e2e_ms,
...
async def benchmark(
    ...
    print("{:<40} {:<10.2f}".format("P100 E2E Latency (ms):", metrics.p100_e2e_latency_ms))
    ...
    print("{:<40} {:<10.2f}".format("P100 TTFT (ms):", metrics.p100_ttft_ms))
    ...
    print("{:<40} {:<10.2f}".format("P100 ITL (ms):", metrics.p100_itl_ms))
    ...
    if (
        ...
        result = {
            ...
            "p100_e2e_latency_ms": metrics.p100_e2e_latency_ms,
            "percentiles_e2e_latency_ms": metrics.percentiles_e2e_latency_ms,
            ...
            "p100_ttft_ms": metrics.p100_ttft_ms,
            "percentiles_ttft_ms": metrics.percentiles_ttft_ms,
            ...
            "p100_itl_ms": metrics.p100_itl_ms,
            "percentiles_itl_ms": metrics.percentiles_itl_ms,
