...
class NixlKVManager(CommonKVManager):
    def __init__(
        ...
        try:
            # Try nixl_cu12 first (for CUDA 12 builds)
            try:
                from nixl_cu12._api import nixl_agent
            except ImportError:
                # Fallback to nixl (for other builds or alias)
            ...
            raise ImportError(
                ...
                "Tried: nixl_cu12._api and nixl._api"
            ) from e
