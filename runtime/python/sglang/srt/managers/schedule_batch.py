...
# Global dp_rank for StepMeshTensorCommunicator to access
# This is set in run_scheduler_process and can be accessed by StepMeshTensorCommunicator
_global_dp_rank: Optional[int] = None

def set_global_dp_rank(dp_rank: Optional[int]):
    """Set the global dp_rank for the current process."""
    global _global_dp_rank
    _global_dp_rank = dp_rank

def get_global_dp_rank() -> Optional[int]:
    """Get the global dp_rank for the current process."""
    return _global_dp_rank
