...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=ServerArgs.server_warmup_timeout,
            help="Timeout in seconds for the internal HTTP warmup request after /get_model_info succeeds. "
            "Increase for very large models or slow first-token compilation (default: 600). "
            "Prefill/decode disaggregation warmups use max(1800, this value).",
        )
        parser.add_argument(
            "--warmups",
            type=str,
